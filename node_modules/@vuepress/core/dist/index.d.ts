import { HeadAttrsConfig, HeadConfig, HeadTag, HeadTagEmpty, HeadTagNonEmpty, LocaleConfig, LocaleData, PageBase, PageData, PageData as PageData$1, PageFrontmatter, PageFrontmatter as PageFrontmatter$1, PageHeader, PageHeader as PageHeader$1, SiteData, SiteData as SiteData$1, SiteLocaleConfig } from "@vuepress/shared";
import { TemplateRenderer } from "@vuepress/utils";
import { Markdown, MarkdownLink, MarkdownOptions, MarkdownSfcBlocks } from "@vuepress/markdown";

//#region src/types/bundler.d.ts
/**
 * Vuepress bundler
 *
...
type Page<ExtraPageData extends Record<string, unknown> = Record<string, unknown>, ExtraPageFrontmatter extends Record<string, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string, unknown> = Record<string, unknown>> = ExtraPageFields & PageBase<ExtraPageFrontmatter> & {
   ...
   */
  data: PageData$1<ExtraPageData, ExtraPageFrontmatter>;
  /**
...
//#endregion
//#region src/types/pluginApi/hooks.d.ts
...
type AliasHook = Hook<Record<string, string> | ((app: App, isServer: boolean) => PromiseOrNot<Record<string, string>>), (app: App, isServer: boolean) => Promise<Record<string, string>>>;
type DefineHook = Hook<Record<string, unknown> | ((app: App, isServer: boolean) => PromiseOrNot<Record<string, unknown>>), (app: App, isServer: boolean) => Promise<Record<string, unknown>>>;
/**
 * List of hooks
 */
interface Hooks {
  ...
  onPageUpdated: LifeCycleHook<[type: 'create', newPage: Page, oldPage: null] | [type: 'delete', newPage: null, oldPage: Page] | [type: 'update', newPage: Page, oldPage: Page]>;
 ...
 */
type HooksExposed = { [K in HooksName]: Hooks[K]['exposed'] };
/**
 * Normalized hooks
 */
type HooksNormalized = { [K in HooksName]: Hooks[K]['normalized'] };
/**
 * Result of hooks
 */
type HooksResult = { [K in HooksName]: Hooks[K]['result'] };
/**
 * Hook item
 */
...
//#endregion
//#region src/types/pluginApi/pluginApi.d.ts
/**
...
interface PluginApi {
   ...
   * All available hooks
   */
  hooks: { [K in HooksName]: HookQueue<K> };
  /**
...
//#endregion
//#region src/types/app/options.d.ts
/**
 * Vuepress app common config that shared between dev and build
 */
interface AppConfigCommon extends Partial<SiteData$1> {
  /**
...
//#endregion
//#region src/types/app/utils.d.ts
/**
...
//#endregion
//#region src/app/prepare/preparePageChunk.d.ts
/**
 * Generate temp file if the page does not have a source file
 */
declare const preparePageChunk: (app: App, page: Page) => Promise<void>;
//#endregion
//#region src/app/prepare/prepareRoutes.d.ts
/**
 * Generate routes temp file
 */
declare const prepareRoutes: (app: App) => Promise<void>;
//#endregion
//#region src/app/createBuildApp.d.ts
/**
 * Create vuepress build app.
 */
declare const createBuildApp: (config: AppConfig) => BuildApp;
//#endregion
//#region src/app/createDevApp.d.ts
/**
 * Create vuepress dev app.
 */
declare const createDevApp: (config: AppConfig) => DevApp;
//#endregion
//#region src/app/resolveAppDir.d.ts
/**
 * Resolve directory utils for vuepress app
 */
declare const resolveAppDir: (options: AppOptions) => AppDir;
//#endregion
//#region src/page/createPage.d.ts
/**
 * Create vuepress page object
 */
declare const createPage: (app: App, options: PageOptions) => Promise<Page>;
//#endregion
//#region src/page/renderPageToVue.d.ts
/**
 * Render page to vue component
 */
declare const renderPageToVue: (app: App, page: Page) => string;
//#endregion
//#region src/constants.d.ts
declare const DEFAULT_IGNORE_PATTERNS: string[];
//#endregion
export { AliasHook, App, AppConfig, AppConfigBuild, AppConfigCommon, AppConfigDev, AppDir, AppDirFunction, AppEnv, AppOptions, AppPropertiesBase, AppPropertiesInitialized, AppWriteTemp, BuildApp, Bundler, BundlerOptions, ClientConfigFileHook, DEFAULT_IGNORE_PATTERNS, DefineHook, DevApp, ExtendsHook, type HeadAttrsConfig, type HeadConfig, type HeadTag, type HeadTagEmpty, type HeadTagNonEmpty, Hook, HookItem, HookQueue, Hooks, HooksExposed, HooksName, HooksNormalized, HooksResult, LifeCycleHook, type LocaleConfig, type LocaleData, Page, type PageData, type PageFrontmatter, type PageHeader, PageOptions, Plugin, PluginApi, PluginConfig, PluginFunction, PluginObject, type SiteData, type SiteLocaleConfig, Theme, ThemeFunction, ThemeInfo, ThemeObject, createBuildApp, createDevApp, createPage, preparePageChunk, prepareRoutes, renderPageToVue, resolveAppDir };